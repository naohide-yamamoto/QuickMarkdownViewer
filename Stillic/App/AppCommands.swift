...
///
/// Stillic intentionally exposes a tiny command surface to preserve
...
struct AppCommands: Commands {
    ...
    var body: some Commands {
        ...
        CommandGroup(replacing: .newItem) {
            ...
            // Stillic uses manual window management instead of DocumentGroup.
            Menu {
        ...
        // Route printing through Stillic's active-document command channel so
        ...
        // fully controlled by the custom Stillic command block.
        ...
        CommandGroup(after: .toolbar) {
            ...
            // and browsers. In Stillic it performs one-way zoom-to-fit.
        ...
        CommandGroup(replacing: .help) {
            Button(action: {
                ...
                Label("Stillic Help", systemImage: "questionmark.circle")
            }
        }
    }
}

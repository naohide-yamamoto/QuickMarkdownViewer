...
struct FileOpenService {
    ...
    private static let markdownOpenPanelLastDirectoryDefaultsKey =
        "stillic.markdownOpenPanel.lastDirectory.v1"
    ...
    /// Extensions Stillic supports in v1.
    ///
    ...
    /// Stillic intentionally does not fully support in v1.
    ///
    ...
    /// Returns true when the URL extension is one Stillic can render.

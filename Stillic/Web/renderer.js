(() => {
  ...
  const highlightThemeStyleIDs = {
    github: "stillic-highlight-theme-github",
    vscode: "stillic-highlight-theme-vscode",
    atomOne: "stillic-highlight-theme-atom-one",
    stackOverflow: "stillic-highlight-theme-stackoverflow"
  };
  const documentTypefaceBodyClassPrefix = "stillic-typeface-";
  const supportedDocumentTypefaces = ["sans-serif", "serif"];
  const documentDensityBodyClassPrefix = "stillic-density-";

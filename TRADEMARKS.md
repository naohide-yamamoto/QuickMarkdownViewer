...
That licence applies to the code unless otherwise noted.
...
If you distribute a modified version of this software, you must rename the app
and replace the icon and other branding unless you have explicit written
permission from Naohide Yamamoto to use the official branding.

This rule exists to avoid confusion about which builds are official.
